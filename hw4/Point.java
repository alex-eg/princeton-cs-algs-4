...
public class Point implements Comparable<Point> {
    ...
    private class SlopeComparator implements Comparator<Point> {
        ...
        public SlopeComparator(Point target) {
            p0 = target;
        }

        public int compare(Point p1, Point p2) {
            var s1 = p0.slopeTo(p1);
            var s2 = p0.slopeTo(p2);
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(points[0].slopeTo(points[0]));
        ...
        StdOut.println(points[2].slopeTo(points[1]));
        StdOut.println(points[5].slopeTo(points[6]));

        StdOut.println(points[0].slopeTo(points[2]));
        StdOut.println(points[2].slopeTo(points[0]));
    }
}
